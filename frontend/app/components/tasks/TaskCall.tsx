...
const dialoque = [
  ...
  ["...мы заметили","подозрительную","операцию","с Вашей карты..."],
  ["...номер карты","**** ****","назовите","три цифры", "с обратной стороны..."]
]
    ...
    <div className="flex gap-2 items-center h-full">
      ...
      <div className="w-full border p-1 rounded flex-1 h-full flex flex-col items-center justify-between">
        ...
        <div className="flex gap-2 items-center">
          <button onClick={handleAnswer}>подозрительно</button>
          <button onClick={handleAnswer}>не подозрительно</button>
        </div>
