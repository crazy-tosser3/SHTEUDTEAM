...
Для удобства запуска мы используем `docker compose up --build`, который автоматически установит проект и его зависимости. После чего сервис будет доступен по адресу 127.0.0.1:8000, в дальнейшем вы сможете вывести его с помощю любого удобного reverce-proxy.
